...
function InputClienteServicio({ clientData, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await onSubmit({ ...serviceData, rif, razonSocial, tipo });
    setServiceData({
      dominio: '',
      tipo_servicio: '',
      hostname: '',
  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="rif" value={rif} onChange={handleChange} placeholder="RIF" />
        <input type="text" name="razonSocial" value={razonSocial} onChange={handleChange} placeholder="Razón Social" />
