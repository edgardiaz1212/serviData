...
const Aprovisionados = () => {
  ...
  const filteredNewServices = store.newServicesCurrentMonth.filter(
    (service) => service.estado_servicio === "Nuevo"
  );
  const filteredReaprovServices = store.newServicesCurrentMonth.filter(
    (service) => service.estado_servicio === "Reaprovisionado"
  );
  const filteredRetiredServices = store.newServicesCurrentMonth.filter(
  ...
  return (
    <>
      <div className="container">
        <h5>
          <ChartNetwork /> Datos del mes en curso
        </h5>
        <p>
          Servicios por estado: Nuevos, Reaprovisionados y Retirados del mes
          actual.
        </p>
